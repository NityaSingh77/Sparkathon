...
import { Package, Map, TrendingUp, BarChart3, Smartphone } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-lg font-semibold">AI Inventory Platform</h1>
                <p className="text-xs text-gray-400">Smart Redistribution System</p>
              </div>
            </div>
