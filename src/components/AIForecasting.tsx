...
import { TrendingUp, Brain, Calendar, Target, Activity, ChevronRight } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-gray-800 rounded-xl p-6">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-semibold text-white">7-Day Demand Forecast</h3>
            ...
            <div key={product.value} className="bg-gray-700 rounded-lg p-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between text-xs">
                  ...
                  <span className={`${product.accuracy > 85 ? 'text-green-400' : 'text-yellow-400'}`}>
